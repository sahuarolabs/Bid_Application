...
namespace Bid501_Server
{
    public class ProductModel
    {
        ...
        public ProductModel()
        {
            ...
            Product waterBottle = new Product("WaterBottle", 004, ts2, true);
            Product calculator = new Product("Calculator", 006, ts1, true);
            Product miniProjector = new Product("Mini Projector", 008,ts3, true);
            Product ps4 = new Product("PS4", 008, ts1, true);
